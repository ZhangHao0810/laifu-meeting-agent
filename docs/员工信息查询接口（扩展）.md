...
- [接口列表](#接口列表)
  - [1. getUserByName - 根据姓名查询员工信息](#1-getuserbyname---根据姓名查询员工信息)
  - [2. getBatchUserInfo - 批量查询员工信息](#2-getbatchuserinfo---批量查询员工信息)
  - [3. searchUsersByName - 模糊搜索员工（可选扩展）](#3-searchusersbyname---模糊搜索员工可选扩展)
---
